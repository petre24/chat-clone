...
import bottomLogo from "./home-Page/home-Page/Images/BottomLogo.jpg";
        ...
        <div className="white-wrapper">
          <div className="wrapper">
            ...
            <div className="img-with-text">
              <h1 className="subtext">Messaging made Quick and Easy</h1>
          ...
          <div className="grey-wrapper">
            <div className="wrapper">
              <strong>
                <h1 className="signup-text">Create a free account now!</h1>
              </strong>
            </div>
            <div className="wrapper">
